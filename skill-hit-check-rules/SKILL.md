...
10. 若本轮存在代码改动且准备最终回复，强制补命中 `comment-placement-granularity-rules`、`comment-completion-gate-rules` 与 `skill-compliance-gate-rules` 后再收口。
