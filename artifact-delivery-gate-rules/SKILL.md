...
3. 再根据任务类型核对必需产物：需求域核对主文档和 SVG，实施域核对实施总览/实施周期文档，验收域核对验收标准或最终验收文档，Bug 域核对根目录 `README.md` 和 SVG，测试域核对时间戳根目录与 `README.md`，审查域核对 `doc/6-审查/` 主文档。
...
4. 按当前任务类型逐项核对磁盘真实产物：
   - 需求域：`doc/2-需求/` 主文档、`.flow.svg`、`.sequence.svg`、`doc/2-需求/data/` 资产引用。
   - 实施域：`doc/3-实施/` 下的实施总览文档，以及按需存在的实施周期文档。
