...
1. 先判断当前阶段：
   - 会话开始、上下文恢复、用户提到历史决策、重复实体、项目事实、“上次”“之前”“我们的规则”“当时怎么说的”等可能已进知识库的问题，回答前先走 `retrieve`。
