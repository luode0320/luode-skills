...
| 需要用真实浏览器打开本地页面、测试环境页面或网站，执行点击、输入、登录、截图、抓取页面数据、查看网络请求或验证前端交互 | 测试域 / 统一浏览器工具路由矩阵 | 由统一矩阵按用户登录态、调试能力、隔离性和高级自动化需求选择 Chrome Plugin、Chrome DevTools MCP 或 `agent-browser`；工具选择不代替功能验证、回归验证或联调归因 |
