...
`curl -u 'api_user:api_password' -d 'id=1010158231077224799&status=abandon&workspace_id=10158231' '${TAPD_API_ENDPOINT}/tcases'`

### curl 使用 OAuth Access Token 鉴权调用示例
`curl -H 'Authorization: Bearer ACCESS_TOKEN' -d 'id=1010158231077224799&status=abandon&workspace_id=10158231' '${TAPD_API_ENDPOINT}/tcases'`
