...
`curl -u 'api_user:api_password' -d 'id=1000000755000016443&name=test&workspace_id=10158231' '${TAPD_API_ENDPOINT}/test_plans'`

### curl 使用 OAuth Access Token 鉴权调用示例
`curl -H 'Authorization: Bearer ACCESS_TOKEN' -d 'id=1000000755000016443&name=test&workspace_id=10158231' '${TAPD_API_ENDPOINT}/test_plans'`
