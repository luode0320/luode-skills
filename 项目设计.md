...
| 编码基线域 | 所有编码任务默认生效的基础质量规则 | `code-minimal-change-rules`、`code-readability-rules`、`code-style-consistency-rules`、`naming-rules`、`code-comment-rules` |
