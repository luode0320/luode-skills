window.SKILL_DICTIONARY = {
  "generated_at": "2026-07-02 12:00:26",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "domain_order": 5,
          "item_order": 9,
          "auto_trigger": "当任务运行在 Windows（PowerShell 或 CMD）且涉及任意代码、文档、配置、脚本、测试资产或生成文本的读写、日志追加、README/Markdown 修改、脚本输出重定向、Git 提交信息或终端显示时触发。用于预防与修复中文乱码（mojibake）、统一跨平台 UTF-8 写入策略，并在落盘前做编码自检；尤其适用于“看到乱码”“中文变成问号/锟斤拷/Ãxx”“同文件中英正常但中文异常”“追加写入后部分行乱码”“担心文件被 GBK/ANSI/默认编码写入”等场景。",
