window.SKILL_DICTIONARY = {
  "generated_at": "2026-08-27 14:24:05",
  ...
  "domains": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "domain_order": 1,
          "item_order": 5,
          "auto_trigger": "项目级 skill 自动沉淀与项目专属规则管理。任务收口时，若本轮涉及项目仓库写操作（代码/文档/配置修改）且产生可复用经验——如 5+ 次 tool call 的非平凡任务、踩坑后找到解法、用户纠正了方法、发现可复用多步骤 workflow——自动评估是否值得沉淀；用户明确要求\"分析项目/总结项目专属 skill/沉淀项目规则\"时同样触发。负责查重后以 project-项目名-主题-rules 命名写入项目根目录 skills/（luode-skills 仓库以仓库根为 skill 资产库），由项目级 AGENTS.md/CLAUDE.md 显式引用命中，不依赖任何工具专属路径；不代替 knowledge-flow 知识库笔记沉淀与 skill-absorption-rules 内部演进。",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          "id": "Git",
          "name": "Git",
          "title": "Git checks out middle commit, test it, then:",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
