  ...
  "domains": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "core_responsibility": "作为跨域统一约定 skill，提供目录、命名和复用策略的单一真相源，供需求、实施、Bug、测试、记忆、项目设计和交付类 skill 统一引用。",
