window.SKILL_DICTIONARY = {
  "generated_at": "2026-08-25 16:44:14",
  ...
  "domains": [
    ...
    },
    {
      ...
      "items": [
        {
          "id": "\"IP Address Query - IP查询\"",
          "name": "\"IP Address Query - IP查询\"",
          "title": "极速数据 IP 查询（Jisu IP）",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 1,
          "auto_trigger": "根据 IP 查归属地与运营商类型。当用户说：这个 IP 是哪里的？是不是机房 IP？或类似 IP 归属问题时，使用本技能。",
        ...
        },
        {
          "id": "\"shell\"",
          "name": "\"shell\"",
          "title": "Shell — Shell Scripting Reference",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 6,
          "auto_trigger": "\"Shell scripting reference — Bash syntax, redirections, process substitution, signal handling, debugging techniques. Use when writing shell scripts, troubleshooting Bash behavior, or automating system tasks.\"",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 10,
          "auto_trigger": "Write reliable Bash scripts with proper quoting, error handling, and parameter expansion.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 15,
          "auto_trigger": "Operate Linux systems avoiding permission traps, silent failures, and common admin mistakes.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 17,
          "auto_trigger": "Write correct MySQL queries with proper character sets, indexing, transactions, and production patterns.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 18,
          "auto_trigger": "Configure Nginx for reverse proxy, load balancing, SSL termination, and high-performance static serving.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 19,
          "auto_trigger": "Avoid common PowerShell mistakes — output behavior, array traps, and comparison operator gotchas.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 20,
          "auto_trigger": "Write reliable Python avoiding mutable defaults, import traps, and common runtime surprises.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 21,
          "auto_trigger": "Write correct, efficient regular expressions across different engines. Triggers: regex, pattern, match, replace, grep.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 22,
          "auto_trigger": "Use SQLite correctly with proper concurrency, pragmas, and type handling.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 23,
          "auto_trigger": "Avoid common VSCode mistakes — settings conflicts, debugger setup, and extension clashes.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 24,
          "auto_trigger": "Build Vue 3 applications with Composition API, proper reactivity patterns, and production-ready components.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 35,
          "auto_trigger": "\"币安 USDT-M 永续合约交易助手。用户问分析、开仓、平仓、跟单、挂单、止盈止损、杠杆、BTC/ETH 交易计划时使用。结合账户余额与持仓，金额用 USDT；不做现货。\"",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 40,
          "auto_trigger": "整理文件夹中的文件，按类型分类到对应子文件夹中。支持按扩展名（文档、图片、视频、压缩包、安装程序、代码等）自动分类，也可自定义规则。当用户提到\"整理文件\"、\"分类文件\"、\"组织文件夹\"、\"清理下载\"、\"file organizer\"、\"organize\"等词语时使用此skill。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        {
          "id": "free-api-50__skillhub",
          "name": "free-api-50__skillhub",
          "title": "中国免费API大全 | China Free API Toolkit",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 47,
          "auto_trigger": "\"Build, test, lint, and format Go projects with integrated dev tooling. Use when compiling binaries, running tests, linting code, or formatting files.\"",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 71,
          "auto_trigger": "Telegram CLI for reading, searching, and sending messages. Use when the user asks about Telegram messages, wants to check inbox, search chats, send messages, or look up contacts and groups.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 77,
          "auto_trigger": "生成 Vue 3 组件模板，支持 Composition API、Options API、TypeScript、SFC 单文件组件，一键生成完整 Vue 组件代码。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
