window.SKILL_DICTIONARY = {
  "generated_at": "2026-06-26 22:15:24",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 33,
          "auto_trigger": "从对话和代码中自动提取、规范化并合并项目事实，写入根目录 `PROJECT_MEMORY.md` 作为唯一长期记忆源。用于项目需要长期记住指标、参数、表字段、缓存键、变量、公式、方法映射或其他反复出现的信息，并且后续对话应优先读取这份记忆的场景。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
