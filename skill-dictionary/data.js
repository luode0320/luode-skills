window.SKILL_DICTIONARY = {
  "generated_at": "2026-06-22 21:14:59",
  ...
  "domains": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "domain_order": 1,
          "item_order": 6,
          "auto_trigger": "当仓库命中 `project.godot`、`.gd`、`.tscn`、`addons/`、`export_presets.cfg` 等 Godot 项目标记，且需要自动补齐项目级规则文件（`AGENTS.md` / `CLAUDE.md`）、Godot CLI 工具约定、图像生成配置模板或检查 Godot 开发环境是否可直接进入执行时强制自动触发。负责把 Godot 项目的环境准备、自举补齐、图像通道模板和只差人工配置的缺口一次性收口。",
      ...
      "items": [
        ...
        },
        {
          ...
          "references": [
            ...
            "windows-wsl-execution-rules/references/vscode-debug-config.md"
          ],
          "agents": [
