window.SKILL_DICTIONARY = {
  "generated_at": "2026-06-27 19:46:11",
  "repo_root": "F:\\luode-skills",
  "plan_doc": "编码skill.md",
  "plan_doc_name": "编码skill.md",
  "summary": {
    "planned_total": 76,
    "implemented_total": 76,
    "planned_missing": 0,
    "seed_total": 21,
    "doc_total": 7,
    "references_total": 285,
    "agents_total": 84
  },
  "downloaded_seeds": {
      ...
      "items": [
        {
          ...
          "domain_order": 3,
          "item_order": 1,
          "auto_trigger": "当用户只提出一句话 idea、粗略想法、老板式方向、新功能愿景或“想做某个能力”，但没有提前整理完整需求资料时触发。负责由 agent 主动侦察、收罗、比对、推理和成文：查当前项目代码、文档、历史需求、数据库线索、配置、上下游服务、第三方调用、用户补充的本地项目路径或 URL，形成有证据来源的需求设计、可行方案和最少待确认问题；必须把已验证有复用价值的资料位置、数据库、URL、项目路径和侦察经验转交 `project-memory-rules` 回写长期记忆。不要用它代替需求主文档接入、需求边界裁决、验收标准或编码实施。",
          "core_responsibility": "主动侦察项目、数据库线索、代码、上下游、用户补充路径和 URL，形成有证据来源的需求设计，并回写可复用记忆。",
        ...
        },
        {
          ...
          "domain_order": 3,
          "item_order": 3,
          "auto_trigger": "当需求描述不完整、缺少前提、缺少字段、缺少流程、缺少业务规则、缺少依赖条件、缺少成功标准、存在多种合理解释或关键方案尚未收敛时触发；如果缺口可能通过当前项目、数据库线索、代码、上下游、历史资料、用户补充路径或 URL 主动获得，必须先联动 requirement-discovery-rules 侦察。负责识别需求缺口并在信息不足时阻断盲目编码推进，同时将缺口分析结果持续更新到 `requirement-intake-rules` 约定、且路径与命名由 `artifact-storage-rules` 统一定义的同一份需求主文档中；不要用它代替需求边界判断、需求变更判断或验收标准细化 skill。",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "title": "test-task-root-layout-rules",
          "status": "implemented",
          "status_label": "已实现",
          "domain_id": "test",
          "domain_label": "测试域",
        ...
        },
        {
          ...
          "title": "test-scattered-asset-location-rules",
          "status": "implemented",
          "status_label": "已实现",
          "domain_id": "test",
          "domain_label": "测试域",
        ...
        },
        {
          ...
          "title": "go-test-compile-path-rules",
          "status": "implemented",
          "status_label": "已实现",
          "domain_id": "test",
          "domain_label": "测试域",
  ...
  "recommendations": [
    "76 个规划 skill 已全部独立落地，后续优化优先检查 description 命中率、相邻 skill 边界和 references 的信息密度。",
