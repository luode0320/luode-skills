window.SKILL_DICTIONARY = {
  "generated_at": "2026-08-20 00:36:52",
  ...
  "domains": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "domain_order": 1,
          "item_order": 2,
          "auto_trigger": "当需要定义、调整或解释项目中 `doc/1-架构/`、`doc/2-需求/`、`doc/3-实施/`、`doc/4-bugs/`、`doc/5-tests/`、活动 `doc/6-review/` 与历史只读 `doc/6-审查/`、`doc/7-验收/`、`doc/`、`skill/` 以及根目录 `项目设计.md` 等研发产物根目录、主入口文件、命名模板、同任务复用策略或跨域文档引用关系时自动触发。负责提供全局唯一的目录与命名单一真相源，并为需求、实施、Bug、测试、6-review、记忆、项目设计和交付类 skill 提供统一引用基准；不要用它代替需求分析、Bug 定位、测试执行、生产代码存放决策或流程分流。",
          "core_responsibility": "根 `test/` 是唯一活动测试代码根，`doc/4-bugs/` 与 `doc/5-tests/` 只保留扁平 md 主文档、证据内联正文；其余目录、命名和复用策略仍由该 skill 统一提供。",
        ...
        },
        {
          ...
          "domain_order": 1,
          "item_order": 5,
          "auto_trigger": "项目级 skill 自动沉淀与项目专属规则管理。任务收口时，若本轮涉及项目仓库写操作（代码/文档/配置修改）且产生可复用经验——如 5+ 次 tool call 的非平凡任务、踩坑后找到解法、用户纠正了方法、发现可复用多步骤 workflow——自动评估是否值得沉淀；用户明确要求\"分析项目/总结项目专属 skill/沉淀项目规则\"时同样触发。负责查重后以 project-项目名-主题-rules 命名写入用户级 skill 目录（经 junction 与 luode-skills 仓库同址），供后续会话自动命中；不代替 knowledge-flow 知识库笔记沉淀与 skill-evolution-rules 内部演进。",
          ...
          "references": [
            "project-local-skills-rules/references/auto-trigger-and-evaluation.md",
            "project-local-skills-rules/references/dedup-and-update.md",
            ...
            "project-local-skills-rules/references/source-notes.md",
            "project-local-skills-rules/references/workbuddy-absorption-map.md"
          ],
          "agents": [
        ...
        },
        {
          ...
          "references": [
            "godot-project-bootstrap-rules/references/godot-mcp-operations.md"
          ],
          "agents": [
        ...
        },
        {
          ...
          "references": [
            ...
            "thread-title-rules/references/workbuddy-host-contract.md"
          ],
          "agents": [
        ...
        },
        {
          ...
          "domain_order": 1,
          "item_order": 11,
          "auto_trigger": "【强制自动触发】当任一 skill 已命中并准备进入研发、分析、侦察、审查、测试、文档或其他实质执行阶段时触发，不依赖用户逐次点名，也不限于固定 skill 映射。统一负责进入前预检、并行分类、成本与写集评估、确认风险可控、真实启动、批次回收、关闭后复查和最终回复前终局扫描；只处理当前会话可枚举的非根 agent，真实关闭必须由资源释放工具成功且复查通过，interrupt_agent 不计作关闭。输出计划线程数、实际启动数、完成数、终态数、关闭数、终局扫描数、仍活跃数、未关闭数、告警原因和回退原因。本仓库项目级完全授权可满足工具显式授权前提，但系统规则、工具元数据、安全边界和用户当前轮明确禁止始终优先。适用于独立问题、证据来源、文件集、模块或职责边界可切分的任务；单一根因裁决、需求或接口边界冻结、数据库 schema 与架构方向等主路径必须串行，旁路证据可在边界清晰且不重复读取大段上下文时并行。不要用本 skill 代替领域执行、最终裁决、测试、审查或验收。",
          ...
          "references": [
            ...
            "parallel-task-dispatch-rules/references/subagent-lifecycle-and-reconciliation.md",
        ...
        },
        {
          ...
          "references": [
            "skill-hit-check-rules/references/deferred-gate-registry.md",
        ...
        },
        {
          ...
          "core_responsibility": "校验注释三 Owner 终检、测试目录一致性、真实运行验证与 `6-review` 风格回归。",
      ...
      "items": [
        ...
        },
        {
          ...
          "references": [
            ...
            "knowledge-flow/references/case-knowledge-spider-absorption.md",
            ...
            "knowledge-flow/references/source-notes.md",
            "knowledge-flow/references/validation-checklist.md",
            "knowledge-flow/references/workbuddy-absorption-map.md"
          ],
          "agents": [
        ...
        },
        {
          ...
          "references": [
            "project-memory-rules/references/environment-probe.md",
            ...
            "project-memory-rules/references/recent-project-session-snapshot-contract.md"
          ],
          "agents": [
      ...
      "items": [
        {
          ...
          "references": [
            "requirement-intake-rules/references/adversarial-gap-interview.md",
            ...
            "requirement-intake-rules/references/workload-mode-routing.md"
          ],
          "agents": [
        ...
        },
        {
          ...
          "core_responsibility": "多来源对象先建“需求与实施计划全量顺序实施方案”，再把已确认需求转成可执行实施总览与实施周期，并明确周期顺序、期次定位、周期内最小任务顺序、AC 完成条件和测试映射。",
          ...
          "references": [
            "implementation-planning-rules/references/cross-session-plan-execution-contract.md",
            ...
            "implementation-planning-rules/references/minimum-plan-grading.md",
            ...
            "implementation-planning-rules/references/plan-devils-advocate-review.md",
            ...
            "implementation-planning-rules/references/tdd-workflow.md",
      ...
      "items": [
        {
          ...
          "references": [
            ...
            "bug-intake-rules/references/bug-discovery-output-template.md",
        ...
        },
        {
          ...
          "domain_order": 4,
          "item_order": 2,
          "auto_trigger": "当问题需要构造步骤、确定触发条件、判断是否稳定发生、确认出现频率或复现环境时触发。负责输出复现路径、稳定性判断、符合 `artifact-storage-rules` 约定的 Bug 主文档记录和无法复现时的结论处理；不要用它代替根因分析。",
        ...
        },
        {
          ...
          "domain_order": 4,
          "item_order": 3,
          "auto_trigger": "当开始分析代码、追调用链、看现有日志、查 trace、结合上下游行为定位 Bug 根因时触发。负责通过静态证据收敛根因、统一记录到 Bug 主文档并区分实现问题与设计问题；不要用它代替运行时调试或修复方案制定 skill。",
        ...
        },
        {
          ...
          "domain_order": 4,
          "item_order": 4,
          "auto_trigger": "当问题已定位，需要形成修改建议、风险评估、备选方案并判断是否应等待用户确认时触发；公共方法、共享模块、接口、数据库、缓存、兼容性、异常语义或历史能力变化的高影响修复自动进入 `#regression-risk` 条件路由。负责把 Bug 域稳定交接到编码域，并统一记录到 Bug 主文档；修复方案必须针对根因、从源头消除问题，拒绝打补丁式修复（表层特判绕过、try-catch 吞异常、对坏数据兜底而不修源头、堆叠 if 特判等）。不要用它代替根因定位或直接实施编码修复。",
        ...
        },
        {
          ...
          "domain_order": 4,
          "item_order": 6,
          "auto_trigger": "当 Bug 修复后需要验证是否真的修好、是否引入副作用、是否需要补测试样例、是否已经满足关闭条件时触发。负责修复后验证闭环、Bug 主文档结论记录和未覆盖说明；不要把它代替功能实现验证或全量回归策略。",
      ...
      "items": [
        {
          ...
          "agents": [
            "code-generation-style-rules/agents/openai.yaml"
          ],
          "has_license": false,
          "focus_points": [
            "优先检查 description 是否具体到触发信号，而不是只写抽象用途。",
            "检查 references 是否足以承接复杂场景，避免 SKILL.md 过厚或过空。",
            "重点看它是否能并行生效，并且不抢位点域或风格回归域职责。"
          ]
        },
        {
        ...
        },
        {
          ...
          "references": [
            ...
            "code-style-consistency-rules/references/style-regression-contract.md",
      ...
      "items": [
        {
          ...
          "domain_order": 6,
          "item_order": 1,
          "auto_trigger": "用于判断前后端同仓、独立后端、独立前端项目中新增或修改目录、包、模块、数据库资产、静态数据、配置、公共结构、工具包、第三方 SDK、中间件、定时任务、异步任务与源码层的唯一位置、职责和依赖方向；目录查询、渲染、初始化和检查统一由本 Skill 的 Catalog 负责。",
          ...
          "references": [
            ...
            "package-structure-rules/references/lookup-and-reference-contract.md",
        ...
        },
        {
          ...
          "domain_order": 6,
          "item_order": 2,
          "auto_trigger": "当新建项目 / 新会话首轮检测到新或空仓库（缺业务代码骨架），或用户提出「微业务 / 伪微服务 / 按业务分目录包 / 业务隔离 / 业务互不关联 / 业务版本化 / 新业务开新包 / 一个项目一个服务的伪微服务」等诉求，或项目已存在微业务标记时自动触发。负责守护单项目单服务中的业务垂直切分、版本化目录隔离和跨业务导入隔离：业务域直连源码根，业务相关逻辑通过 `router/<v?>/`、`controller/<v?>/`、`entity/<v?>/`、`service/<v?>/` 四类版本化目录完全隔离（包名用 `v?router`、`v?controller`、`v?entity`、`v?service` 别名引用），业务域之间禁止直接导入对方任何目录；提供幂等脚手架、标记与确定性校验，并以 CodeGraph 导入节点作为审查证据。具体目录、引用边界由 `package-structure-rules` 唯一拥有；不要用它代替需求分析、实施规划、分层落点或实际编码。",
          "core_responsibility": "把单项目单服务按业务垂直切分为互不关联的业务域，业务域直连源码根、业务相关逻辑通过 `router/<v?>/`、`controller/<v?>/`、`entity/<v?>/`、`service/<v?>/` 四类版本化目录隔离（包名用 `v?router`/`v?controller`/`v?entity`/`v?service` 别名引用）、业务域之间禁止直接导入对方任何目录；定义多语言统一目录布局、每业务域 README 与全局业务索引 md 规则，并提供幂等脚本建版本骨架、写标记与校验跨业务非法依赖，让 AI 只读单业务上下文即可分析。分层落点交给 `package-structure-rules`。",
        ...
        },
        {
          ...
          "domain_order": 6,
          "item_order": 3,
          "auto_trigger": "当新增或修改工具类、通用方法、公共组件、工具函数、通用常量或复用代码时触发。负责统一公共工具代码的公共资格、复用检索、调用边界、同语义防重复封装和“7天冻结”低风险演进策略；最近修改时间超过7天且被多处复用的通用代码默认只允许新增能力，不允许直接修改既有行为；最近7天内新增/修改的通用代码可继续迭代；简单处理禁止为了“未来扩展”或“统一模式”提前抽公共接口 / 接口实现对；目录归位、二级子目录、依赖方向和根目录堆文件问题统一转交 `package-structure-rules`，不要用本 skill 代替业务逻辑抽象、包结构规则或具体实现细则。",
          "core_responsibility": "统一公共资格、复用检索、调用边界、防重复封装和 7 天冻结策略；`util`、`common/util`、二级子目录、依赖方向等目录落点交给 `package-structure-rules`。",
        ...
        },
        {
          ...
          "references": [
            ...
            "database-schema-rules/references/source-notes.md",
            "database-schema-rules/references/table-design-standards.md",
            "database-schema-rules/references/workbuddy-absorption-map.md"
          ],
          "agents": [
    ...
    },
    {
      "id": "style_regression",
      "label": "代码风格回归域",
      "description": "真实测试后的格式、写法、位置与既有风格回归",
      "order": 7,
      "implemented_count": 0,
      "planned_count": 1,
      "seed_count": 0,
      ...
      "items": [
        {
          "id": "code-style-consistency-rules",
          "name": "code-style-consistency-rules",
          "title": "code-style-consistency-rules",
          "status": "planned",
          "status_label": "规划中",
          "domain_id": "style_regression",
          "domain_label": "代码风格回归域",
          "domain_description": "真实测试后的格式、写法、位置与既有风格回归",
          "domain_order": 7,
          "item_order": 1,
          "auto_trigger": "当代码、脚本、配置或测试代码新增/修改，且真实测试已经完成准备做风格回归时触发。",
          "core_responsibility": "作为唯一活动 `6-review` 入口，输出 `STYLE: PASS` 或 `STYLE: FIX_REQUIRED`。",
          "skill_path": "",
          "directory_path": "",
          "directory": "",
          "sections": [],
          ...
          "focus_points": [
            "先补齐触发 description、邻接边界和最小 references，再决定是否正式建目录。",
            "优先确认它与同域相邻 skill 的拆分边界，避免新建后职责重叠。",
            "重点看它只在真实测试后检查写法、位置与格式，不越界替代功能测试。"
          ]
        }
      ]
    },
      ...
      "items": [
        {
          ...
          "references": [
            ...
            "test-strategy-rules/references/production-test-pollution.md",
        ...
        {
          "id": "browser-use-cloud-rules",
          "name": "browser-use-cloud-rules",
          "title": "Browser Use Cloud 安全路由规则",
          "status": "implemented",
          "status_label": "已实现",
          "domain_id": "test",
          "domain_label": "测试域",
          ...
          "domain_order": 8,
          "item_order": 4,
          "auto_trigger": "凭据默认来源为项目代码/项目配置/普通维护文档，环境变量仅作运行时覆盖；禁止在过程性输出中回显凭据原值。当浏览器任务明确需要 Browser Use Cloud 的云端自主长链、托管并发、地域出口、托管代理、隐身浏览或服务商提供的合规验证码处理能力，或用户明确点名 Browser Use Cloud 时触发。作为 Browser Use Cloud 执行、安全、费用确认和 session 生命周期的唯一 Owner，负责检查 `BROWSER_USE_API_KEY`、Billing 余额、运行时 MCP 工具 schema 的硬费用上限、逐次 `run_session` / `send_task` 确认、默认无 profile/录制/保活，以及任务结束后的停止与费用回读。普通网页检索、真实 Chrome 登录态、应用内 Browser、DevTools 调试、本地 agent-browser、HAR/视觉 diff/trace 不使用本 Skill；不得用 Cloud 绕过权限、安全策略或真实浏览器连接失败。",
          "core_responsibility": "作为 Cloud 执行、安全、费用和 session 生命周期的唯一 Owner；每次收费动作前检查本机 key、Billing、当前动作硬费用上限并取得当次确认。",
          "skill_path": "browser-use-cloud-rules/SKILL.md",
          "directory_path": "browser-use-cloud-rules",
          "directory": "browser-use-cloud-rules",
          "sections": [
            "目标与唯一 Owner 边界",
            "触发后先做什么",
            "预检命令",
          ...
          "references": [
            "browser-use-cloud-rules/references/routing-and-safety.md"
          ],
          "agents": [
            "browser-use-cloud-rules/agents/openai.yaml"
          ],
          "has_license": false,
          "focus_points": [
            "优先检查 description 是否具体到触发信号，而不是只写抽象用途。",
        ...
        },
        {
          ...
          "domain_order": 8,
          "item_order": 5,
          "auto_trigger": "当需要验证新功能、修改后的功能、接口行为、页面交互、输入输出结果是否满足当前需求、当前变更和完成条件时触发。负责界定本次功能验证范围、验证步骤、通过驳回标准和结论留痕；必须以 `artifact-storage-rules` 与 `test-strategy-rules 的 test-asset-governance 条件路由` 为基准，把功能验证结论写回测试主文档，把可执行测试代码、mock、stub、fake、fixture 和 helper 放入根 `test/` 的源码镜像目录，并把详细执行证据放到同一份 `doc/5-tests/` 测试主文档的证据小节；模拟程序与对应测试使用同一源码相对路径，`doc/5-tests/` 仅保存非可执行证据；Go 测试还必须遵循 `test-program-rules` 的《Go 测试编译路径（强制）》；同时强制禁止为了测试目的污染生产代码。不要用它代替 test-strategy-rules、test-strategy-rules 的 test-asset-governance 条件路由或 test-regression-rules。",
        ...
        },
        {
          ...
          "domain_order": 8,
          "item_order": 7,
          "auto_trigger": "当需要建立、刷新或核对项目接口事实基线时触发，包括扫描接口路由/controller、维护 Swagger/OpenAPI 双索引一致性、构建 provider/consumer 依赖图、管理参数来源与可复用参数的生命周期状态、判定基线是否漂移。负责在 `doc/5-tests/基线/` 长期资产库里持续沉淀接口清单、依赖图、参数来源和可复用参数；本 skill 只维护接口事实资产，不负责执行测试、判定接口响应或输出上线放行结论（测试执行统一走 apifox 测试链路）。",
          "core_responsibility": "负责接口路由扫描、双索引一致性、依赖图和参数来源生命周期管理，不持有测试执行实现。",
        ...
        },
        {
          ...
          "domain_order": 8,
          "item_order": 8,
          "auto_trigger": "Apifox CLI 全功能入口。覆盖登录/项目管理、API 设计、环境/Mock、分支协作、测试用例、测试场景、自动化测试/CI、导入导出、API 生命周期工作流及问题排查。按需加载命令模块。",
          "core_responsibility": "统一承接接口级测试执行：AI 团队项目定位（`ai-team-project.md`）、接口同步（`api-sync-to-apifox.md`）、范围选择（`test-selection-policy.md`）、用例生成（`test-case-generation.md`）、数据构造与判定（`test-data-and-judgement.md`）、陷阱规避（`testing-pitfalls.md`）；执行通道见 `test-strategy-rules` 的《接口测试执行通道（强制）》，原 `project-interface-release-execution-rules` 已并入。",
          "skill_path": "apifox-cli__skillhub/SKILL.md",
          "directory_path": "apifox-cli__skillhub",
          "directory": "apifox-cli__skillhub",
          "sections": [
            "安装",
            "模块按需加载",
            "核心共享规则"
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          "id": "\"goal\"",
          "name": "\"goal\"",
          "title": "Goal — Goal Setting & Achievement Reference",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 2,
          "auto_trigger": "\"Goal setting reference — SMART goals, OKRs, habit formation, accountability systems. Use when setting personal or professional goals, designing habit systems, or implementing OKR frameworks.\"",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "goal__skillhub/SKILL.md",
          "directory_path": "goal__skillhub",
          "directory": "goal__skillhub",
          "sections": [
            "When to Use",
            "Commands"
          ],
        ...
        },
        {
          "id": "2d-game-dev",
          "name": "2d-game-dev",
          "title": "2D 游戏开发（Godot 4 + GDScript）",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "auto_trigger": ">-",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "2d-game-dev__skillhub/SKILL.md",
          "directory_path": "2d-game-dev__skillhub",
          "directory": "2d-game-dev__skillhub",
          "sections": [
            "1. 环境准备",
            "2. 项目脚手架",
            "3. 架构规范（避免后期重构的最少规则）",
        ...
        },
        {
          "id": "3d-game-dev",
          "name": "3d-game-dev",
          "title": "3D 游戏开发（Godot 4 + GDScript）",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "auto_trigger": ">-",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "3d-game-dev__skillhub/SKILL.md",
          "directory_path": "3d-game-dev__skillhub",
          "directory": "3d-game-dev__skillhub",
          "sections": [
            "1. 环境与脚手架",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 8,
          "auto_trigger": "Run iterative agent loops until success criteria are met. Controlled autonomous iteration.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "loop__skillhub/SKILL.md",
          "directory_path": "loop__skillhub",
          "directory": "loop__skillhub",
          "sections": [
            "Data Storage",
            "Scope",
            "Quick Reference",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 11,
          "auto_trigger": "当需求、实施、Bug、真实测试或 6-review 风格回归任务准备最终收口，且本轮已经产生或应当产生持久化研发文档时自动触发。负责在最终完成前核对文档是否已经真实落盘到 `artifact-storage-rules` 约定的位置，检查主入口文件、必需配套文件和同任务复用关系是否完整；若文档仍停留在最终回复、临时说明或内存结论中，必须阻断收口并先补齐落盘。适用于需求主文档、实施文档、Bug 扁平主文档、测试扁平主文档与 `doc/6-review` 风格回归记录；历史 `doc/6-审查` 与 `doc/7-验收` 仅只读兼容，不代替需求分析、Bug 定位或真实测试本身。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          ...
          "references": [
            ...
            "artifact-delivery-gate-rules/references/natural-writing-ai-taste-removal.md",
            ...
            "artifact-delivery-gate-rules/references/style-regression-template.md",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 14,
          "auto_trigger": "在无 C 工具链的 Windows 环境(或任何 CGO_ENABLED=0 环境)下,验证 c-shared Go 插件包(cgo)的逻辑与单元测试。当插件包含 import \"C\" 的 main.go 导致 go build/go vet/go test 报 undefined 符号或 IgnoredGoFiles 时使用。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "cgo-plugin-isolated-test/SKILL.md",
          "directory_path": "cgo-plugin-isolated-test",
          "directory": "cgo-plugin-isolated-test",
          "sections": [
            "触发场景",
        ...
        },
        {
          "id": "charset-fix",
          "name": "charset-fix",
          "title": "Windows Character Encoding Fix for AI Agents",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "auto_trigger": ">-",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "charset-fix__skillhub/SKILL.md",
          "directory_path": "charset-fix__skillhub",
          "directory": "charset-fix__skillhub",
          "sections": [
            "Problem",
            "Quick Fix",
            "Verification",
        ...
        {
          "id": "continuous-code-quality-supervisor-rules",
          ...
          "directory": "continuous-code-quality-supervisor-rules",
          "sections": [
            "触发闸门",
            "执行流程",
            "责任边界",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 19,
          "auto_trigger": "Get cryptocurrency token price and generate candlestick charts via CoinGecko API or Hyperliquid API. Use when user asks for token price, crypto price, price chart, or cryptocurrency market data.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "crypto-price__skillhub/SKILL.md",
          "directory_path": "crypto-price__skillhub",
          "directory": "crypto-price__skillhub",
          "sections": [
            "Usage",
            "Output",
            "Chart Details",
        ...
        {
          "id": "crypto-quant-analysis",
          "name": "crypto-quant-analysis",
          "title": "Crypto Quantitative Analysis v2.2",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
        ...
        {
          "id": "docker-direct-deploy",
          "name": "docker-direct-deploy",
          "title": "镜像直传部署 Workflow 生成",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "auto_trigger": ">-",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "docker-direct-deploy/SKILL.md",
          "directory_path": "docker-direct-deploy",
          "directory": "docker-direct-deploy",
          "sections": [
            "何时使用（触发条件）",
            "生成步骤",
            "参数清单",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 26,
          "auto_trigger": "\"Interact with GitHub using the `gh` CLI. Use `gh issue`, `gh pr`, `gh run`, and `gh api` for issues, PRs, CI runs, and advanced queries.\"",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "github/SKILL.md",
        ...
        {
          "id": "github-pages-auto-deploy",
          "name": "github-pages-auto-deploy",
          "title": "GitHub Pages 自动部署技能",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 27,
          "auto_trigger": "\"Configure automatic website deployment to GitHub Pages with GitHub Actions and custom domain support. Use when a static site should deploy automatically after code is pushed.\"",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "github-pages-auto-deploy/SKILL.md",
          "directory_path": "github-pages-auto-deploy",
          "directory": "github-pages-auto-deploy",
          "sections": [
            "功能",
            "适用场景",
            "快速开始",
        ...
        },
        {
          ...
          "auto_trigger": "|",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "humanizer__skillhub/SKILL.md",
          "directory_path": "humanizer__skillhub",
          "directory": "humanizer__skillhub",
          "sections": [
            "Your Task",
        ...
        },
        {
          ...
          "references": [
            "long-run-loop-rules/references/completion-marker-pattern.md",
            "long-run-loop-rules/references/loop-config-schema.md",
            "long-run-loop-rules/references/safety-mechanisms.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 33,
          "auto_trigger": "\"Transform AI agents from task-followers into proactive partners that anticipate needs and continuously improve. Now with WAL Protocol, Working Buffer, Autonomous Crons, and battle-tested patterns. Part of the Hal Stack 🦞\"",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "proactive-agent__skillhub/SKILL.md",
          "directory_path": "proactive-agent__skillhub",
          "directory": "proactive-agent__skillhub",
          "sections": [
          ...
          "references": [
            "proactive-agent__skillhub/references/onboarding-flow.md",
            "proactive-agent__skillhub/references/security-patterns.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
        ...
        },
        {
          "id": "quant-analyst",
          "name": "quant-analyst",
          "title": "Quantitative Trading Skill",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 34,
          "auto_trigger": "Professional quantitative trading system for cryptocurrency - backtesting, paper trading, live trading, and strategy optimization",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "quant-analyst__skillhub/SKILL.md",
          "directory_path": "quant-analyst__skillhub",
          "directory": "quant-analyst__skillhub",
          "sections": [
            "Installation",
            "Core Features",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 35,
          "auto_trigger": "当新增或修改 Redis 操作、缓存读写、键值查询、TTL 检查、Redis 监控、备份导出导入、FLUSHDB 清理或 redis-cli 命令时自动触发。负责统一 Redis 实例的连接约定、类型识别读取、键健康检查、监控判读、备份恢复格式与危险操作安全红线；连接配置必须使用 REDIS_HOST/PORT/DB/PASSWORD 环境变量约定，读取必须按 TYPE 自动分发，FLUSHDB 必须双确认；不要用它代替 database-query-rules（SQL/GORM 访问）、database-schema-rules（表结构）或缓存 key 设计/失效策略约束（项目级缓存策略）。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "redis-usage-rules/SKILL.md",
          "directory_path": "redis-usage-rules",
          "directory": "redis-usage-rules",
          "sections": [
            "Skill 作用与适用场景",
            "自动触发信号",
            "进入后先做什么",
          ...
          "references": [
            "redis-usage-rules/references/absorption-score-record.md",
            "redis-usage-rules/references/redis-monitoring-backup-and-safety.md",
            "redis-usage-rules/references/redis-usage-and-commands.md",
            "redis-usage-rules/references/source-notes.md",
            "redis-usage-rules/references/workbuddy-absorption-map.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
        ...
        {
          "id": "self-ent-tech-database-design",
          ...
          "domain_order": 10,
          "item_order": 36,
          "auto_trigger": "\"数据库设计与优化指南，覆盖ER建模、范式设计、索引策略、查询优化与分库分表方案。\"",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "self-ent-tech-database-design__skillhub/SKILL.md",
          "directory_path": "self-ent-tech-database-design__skillhub",
          "directory": "self-ent-tech-database-design__skillhub",
          "sections": [
            "角色设定",
            "触发条件",
            "执行流程",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 37,
          "auto_trigger": "\"Captures learnings, errors, and corrections to enable continuous improvement. Use when: (1) A command or operation fails unexpectedly, (2) User corrects Claude ('No, that's wrong...', 'Actually...'), (3) User requests a capability that doesn't exist, (4) An external API or tool fails, (5) Claude realizes its knowledge is outdated or incorrect, (6) A better approach is discovered for a recurring task. Also review learnings before major tasks.\"",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "self-improving-agent__skillhub/SKILL.md",
          "directory_path": "self-improving-agent__skillhub",
          "directory": "self-improving-agent__skillhub",
          "sections": [
          ...
          "references": [
            "self-improving-agent__skillhub/references/examples.md",
            "self-improving-agent__skillhub/references/hooks-setup.md",
            "self-improving-agent__skillhub/references/openclaw-integration.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
        ...
        {
          "id": "skill-absorption-rules",
          "name": "skill-absorption-rules",
          "title": "Skill 调整规则（外部吸收 + 内部更新）",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "references": [
            "skill-absorption-rules/references/absorption-decision-matrix.md",
            "skill-absorption-rules/references/case-apifox-absorption-domain-dedup.md",
            "skill-absorption-rules/references/case-grill-me-absorption.md",
            "skill-absorption-rules/references/case-java-story-develop-absorption.md",
            "skill-absorption-rules/references/darwin-rubric.md",
            "skill-absorption-rules/references/source-notes.md",
            "skill-absorption-rules/references/workbuddy-absorption-map.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
        ...
        },
        {
          ...
          "references": [
            "ubuntu-wsl-system-cleanup__skillhub/references/orphaned-tool-patterns.md",
            "ubuntu-wsl-system-cleanup__skillhub/references/targets.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 42,
          "auto_trigger": "凭据默认来源为项目代码/项目配置/普通维护文档，环境变量仅作运行时覆盖；禁止在过程性输出中回显凭据原值。TAPD 写评论工具。在需求、缺陷、任务等业务对象下添加评论，支持 Markdown / HTML / 纯文本自动识别，Markdown 自动转 HTML。支持 @提及、回复评论、富文本格式。通过 Python 脚本调用，方便 AI 直接写评论。当用户给出 `tapd.cn` 链接并要求评论 / 回复时随 `tapd-openapi` 自动联动触发；执行前遵守 `tapd-openapi` 的环境预检，`TAPD_TOKEN` 未配置时阻断并提示用户在项目代码/配置或环境变量中配置。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 43,
          "auto_trigger": "凭据默认来源为项目代码/项目配置/普通维护文档，环境变量仅作运行时覆盖；禁止在过程性输出中回显凭据原值。TAPD OpenAPI 命令行工具。将 TAPD 平台的全量 OpenAPI 封装为 tapd-cli 命令，适用于终端脚本、自动化管线和 AI Agent调用。当用户给出 `tapd.cn` 链接且需要批量 / 终端化操作时随 `tapd-openapi` 自动联动触发；执行前遵守 `tapd-openapi` 的环境预检，`TAPD_TOKEN` 未配置时阻断并提示用户在项目代码/配置或环境变量中配置。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        {
          "id": "tapd-env-bootstrap",
          "name": "tapd-env-bootstrap",
          "title": "TAPD 环境引导（本机事实，2026-08-18 建档）",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 44,
          "auto_trigger": "本机 TAPD 凭据环境事实（luode 专用）。当涉及 TAPD OpenAPI 操作、TAPD 环境预检、TAPD_TOKEN 缺失或配置位置疑问、与 tapd-openapi 等技能配合排查\"未配置\"报错时自动加载。记录本机 TAPD 凭据的真实存放位置与注入机制：~/.tapd/env.sh（Windows 与 WSL 各一份）+ Windows 用户级环境变量注入，取代 tapd-openapi SKILL.md 中\"写入 .codex/config.toml\"的旧指引。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "tapd-env-bootstrap/SKILL.md",
          "directory_path": "tapd-env-bootstrap",
          "directory": "tapd-env-bootstrap",
          "sections": [
            "本机 TAPD 凭据配置（唯一权威事实）",
        ...
        },
        {
          ...
          "references": [
            ...
            "tapd-openapi/references/id-conversion.md",
            "tapd-openapi/references/iterations/listiterations.md",
            "tapd-openapi/references/releases.md",
            "tapd-openapi/references/scm-keywords.md",
            ...
            "tapd-openapi/references/workflows.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 47,
          "auto_trigger": "当新增或修改测试程序、模拟程序、验证脚本、数据构造脚本、测试辅助代码（mock、stub、fake、fixture）时触发；当 Go 测试路径进入编译链路、出现源码目录 `*_test.go`、中文可编译路径或白盒同包测试诉求时，也由本 skill 统一处理。负责测试程序职责拆分、辅助代码边界、长期保留策略，以及 Go 测试可编译路径必须保持 ASCII、源码目录禁放 `*_test.go`、白盒诉求按三级替代出路降级且禁止改动生产代码的强制约束；必须以 `artifact-storage-rules` 与 `test-strategy-rules 的 test-asset-governance 条件路由` 为落点真相，把真实测试代码、脚本、mock、stub、fake、fixture 放入根 `test/` 的 ASCII 源码镜像目录，模拟程序与对应测试使用同一源码相对路径，把测试主文档以及内联其中的日志、报告和非可执行产物放入 `doc/5-tests/` 的扁平 md，且该目录不承载任何可执行测试或模拟程序；第三方 API 文档缺失响应模型时，必须先用测试脚本探测真实响应，再反推结构体定义；强制禁止为了测试目的污染生产代码（新增测试专用方法、测试专用数据、测试专用结构体字段等）。运行时 Mock（本地开发编译进主二进制、替代不可用上游的模拟实现）不属测试资产，由根 `mock/` 独立管理，不得进入 `test/` 或业务源码目录。运行时 Mock（本地开发编译进主二进制、替代不可用上游的模拟实现）不属测试资产，由根 `mock/` 独立管理，不得进入 `test/` 或业务源码目录。测试脚本建议输出关键过程日志便于定位失败，但过程日志完整性默认为自查项、非放行硬阻断。不要用它代替 `test-strategy-rules`、功能验证规则或回归验证规则。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
        ...
        },
        {
          "id": "trade-executor",
          "name": "trade-executor",
          "title": "Skill: trade-executor（接口定义）",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 49,
          "auto_trigger": "Execute cryptocurrency trades on exchanges (Binance, OKX) with risk controls, user confirmation, and audit logging.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "trade-executor__skillhub/SKILL.md",
          "directory_path": "trade-executor__skillhub",
          "directory": "trade-executor__skillhub",
          "sections": [
            "概述",
            "触发条件",
            "前置条件（全部满足才执行）",
        ...
        {
          "id": "vscode-fullstack-debug",
          "name": "vscode-fullstack-debug",
          "title": "VS Code 全栈调试配置（Go 后端 + 前端）",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 51,
          "auto_trigger": "为 Go 后端 + 前端全栈仓库生成/更新 .vscode 调试配置，支持一键启动前后端。当用户提到\"在 .vscode 加一个前后端同时启动的任务/配置\"、\"一键启动前后端\"、\"添加 vscode 调试配置\"、\"为项目配置 launch.json/tasks.json\"时使用，即使他们没明确说\"调试\"。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "vscode-fullstack-debug/SKILL.md",
          "directory_path": "vscode-fullstack-debug",
          "directory": "vscode-fullstack-debug",
          "sections": [
            "触发与范围",
            "动手前先探测仓库（必须）",
        ...
        },
        {
          ...
          "references": [
            "write/references/durable-context.md",
            "write/references/mode-long-form.md",
            "write/references/mode-public-reply.md",
            "write/references/mode-release-notes.md",
            "write/references/write-en.md",
            "write/references/write-product-localization.md",
            "write/references/write-zh-bilingual.md",
            "write/references/write-zh-prose.md",
            "write/references/write-zh-release-notes.md",
            "write/references/write-zh.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
        ...
        {
          "id": "wsl-chrome-cdp__skillhub",
          "name": "wsl-chrome-cdp__skillhub",
          "title": "wsl-chrome-cdp - WSL2 访问 Windows Chrome 浏览器",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "auto_trigger": "",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "wsl-chrome-cdp__skillhub/SKILL.md",
          "directory_path": "wsl-chrome-cdp__skillhub",
          "directory": "wsl-chrome-cdp__skillhub",
          "sections": [
            "📋 技能描述",
            "🚀 使用方法",
            "📁 文件结构",
        ...
        {
          "id": "wsl-path-converter",
          "name": "wsl-path-converter",
          "title": "WSL path conversion skills",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 59,
          "auto_trigger": "Convert Windows paths to WSL paths for file operations in WSL environment",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "wsl-path-converter__skillhub/SKILL.md",
          "directory_path": "wsl-path-converter__skillhub",
          "directory": "wsl-path-converter__skillhub",
          "sections": [
        ...
        {
          "id": "wsl-powershell__skillhub",
          "name": "wsl-powershell__skillhub",
          "title": "WSL-PowerShell Controller",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "auto_trigger": "",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "wsl-powershell__skillhub/SKILL.md",
          "directory_path": "wsl-powershell__skillhub",
          "directory": "wsl-powershell__skillhub",
          "sections": [
            "How It Works",
            "Usage",
            "Common Examples",
        ...
        {
          "id": "wsl-service-deploy",
          "name": "wsl-service-deploy",
          "title": "WSL Service Deploy",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "auto_trigger": ">-",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "wsl-service-deploy__skillhub/SKILL.md",
          "directory_path": "wsl-service-deploy__skillhub",
          "directory": "wsl-service-deploy__skillhub",
          "sections": [
            "核心工作流",
          ...
          "references": [
            "wsl-service-deploy__skillhub/references/wsl-commands.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
        ...
        {
          "id": "wsl-shell-reliability",
          "name": "wsl-shell-reliability",
          "title": "WSL Shell Reliability",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 62,
          "auto_trigger": "Reliability-first shell selection policy for AI agents on Windows. Choose WSL or PowerShell based on execution risk, not preference.",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "wsl-shell-reliability__skillhub/SKILL.md",
          "directory_path": "wsl-shell-reliability__skillhub",
          "directory": "wsl-shell-reliability__skillhub",
          "sections": [
            "Trigger conditions",
          ...
          "references": [
            "wsl-shell-reliability__skillhub/references/REFERENCE.md",
            "wsl-shell-reliability__skillhub/references/SCENARIOS.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
        ...
        {
          "id": "wsl-windows-bridge",
          "name": "wsl-windows-bridge",
          "title": "WSL ↔ Windows Cross-System Bridge",
          "status": "seed",
          "status_label": "扩展种子",
          "domain_id": "seed",
          "domain_label": "扩展种子",
          ...
          "domain_order": 10,
          "item_order": 63,
          "auto_trigger": "'WSL ↔ Windows cross-system bridge for OpenClaw agents. Provides win-python / win-ps / win-cmd / win-copy / win-run-py / win-path to invoke Windows Python (Anaconda), execute PowerShell/CMD commands, and read/write Windows files from WSL2. Ideal for quantitative trading (QMT/xtquant), cross-system file operations, and Windows environment scripting.'",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "wsl-windows-bridge__skillhub/SKILL.md",
          "directory_path": "wsl-windows-bridge__skillhub",
          "directory": "wsl-windows-bridge__skillhub",
          "sections": [
            "Features",
            "Requirements",
            "First-Time Setup",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 64,
          "auto_trigger": "DexPaprika MCP Server是一个提供实时加密货币和DEX数据访问的API服务，专为AI助手设计，无需配置即可获取代币、流动池和DEX数据。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "cryptocurrency-data-api__skillhub/SKILL.md",
          "directory_path": "cryptocurrency-data-api__skillhub",
          "directory": "cryptocurrency-data-api__skillhub",
          "sections": [
            "⚠️ 强制要求：API 密钥",
            "工作流程（必须遵守）",
            "工具选择规则",
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 65,
          "auto_trigger": "当用户要查 BTC/ETH 等加密货币行情时使用。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
          "skill_path": "z-data-crypto__skillhub/SKILL.md",
          "directory_path": "z-data-crypto__skillhub",
          "directory": "z-data-crypto__skillhub",
          "sections": [
            "一、定位 / 适用边界",
            "二、触发词",
            "三、章节地图",
          ...
          "references": [
            "z-data-crypto__skillhub/references/参考.md"
          ],
          "agents": [],
          "has_license": false,
          "focus_points": [
  ...
  "docs": [
    ...
    },
    {
      "id": "doc:PROJECT_TEST",
      "name": "PROJECT_TEST",
      "file_name": "PROJECT_TEST.md",
      "title": "项目测试约定（PROJECT_TEST.md）",
      "kind": "其他文档",
