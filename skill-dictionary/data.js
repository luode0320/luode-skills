window.SKILL_DICTIONARY = {
  "generated_at": "2026-06-27 00:56:23",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 34,
          "auto_trigger": "从对话和代码中自动提取、规范化并合并项目代码风格示例，写入根目录 `PROJECT_STYLE.md` 作为唯一风格记忆源。用于项目需要长期记住方法、注释、类、结构体、变量、异步、日志、错误处理、接口、工具调用、循环等代码风格样例，并且后续写代码应优先参考这份风格记忆的场景。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
