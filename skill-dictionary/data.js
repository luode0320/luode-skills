window.SKILL_DICTIONARY = {
  "generated_at": "2026-08-19 18:50:02",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "domain_order": 10,
          "item_order": 35,
          "auto_trigger": "当用户表达吸收、借鉴、融合、优化外部 skill（如\"吸收某个skill的精华\"\"这个skill能不能吸收到我们skill\"\"借鉴XX skill的思路\"\"把XX skill的精华融进我们的skill\"\"优化我们的skill，让skill更强大\"），或主动引入外部种子（市场、GitHub、LobeHub、coze、SkillsMP 等来源的 SKILL.md、README、指南）用于改进自有 skill 体系时触发。负责把外部 skill 拆成原子精华、逐条对照本地现状裁决（保留本地/合并/拒绝）、给出落点与简化建议、按 8 维评分与棘轮机制验证改进是否真实成立，并登记吸收裁决表与来源记录；它是外部精华进入自有 skill 体系的唯一总入口。若外部精华已经在本地更强或重复命中，裁决为保留本地并记录理由，不重复吸收。不要用它代替 skill-evolution-rules（内部 gap 演进）、skill-audit-rules（多 skill 职责审计）或具体业务实现。",
          "core_responsibility": "当前已在仓库中，但尚未并入主规划域表。",
