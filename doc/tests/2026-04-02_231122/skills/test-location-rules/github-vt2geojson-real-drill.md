...
2. 创建 `doc/tests/2026-04-02_232735/真实遗留散落测试资产迁移演练/README.md`。
3. 将根目录 `test.js` 迁移到 `doc/tests/2026-04-02_232735/package-root/test.js`。
4. 将根目录 `fixtures/` 迁移到 `doc/tests/2026-04-02_232735/package-root/fixtures/`。
...
- 本文件是 `doc/tests/2026-04-02_231122/test-location-rules拆分对照验证/README.md` 的第四轮补充证据文档。
