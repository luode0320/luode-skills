...
- 详细案例与逐条对照：`doc/tests/2026-04-02_231122/skills/test-location-rules/comparison-cases.md`
- 第二轮边界与联动验证：`doc/tests/2026-04-02_231122/skills/test-location-rules/routing-edge-cases.md`
- 第三轮动态样例验证：`doc/tests/2026-04-02_231122/skills/test-location-rules/dynamic-execution-cases.md`
- 第四轮 GitHub 真实项目演练：`doc/tests/2026-04-02_231122/skills/test-location-rules/github-vt2geojson-real-drill.md`
...
- 非触发场景、跨 skill 联动顺序和 `doc/tests/` 根目录内的 Go 特例路径
...
5. 再执行第二轮“边界与联动验证”，确认新 skill 集合不会误触发、不会漏掉联动顺序，也不会在 `doc/tests/` 根目录内部漏掉 Go 路径问题。
...
- 当前未发现约束强度明显弱化的场景。
- 第二轮补充验证的 4 个边界场景也全部通过，对“非触发”“多 skill 联动”和“`doc/tests/` 根目录内 Go 特例”都未发现承接空洞。
...
- `doc/tests/2026-04-02_231122/skills/test-location-rules/comparison-cases.md`
- `doc/tests/2026-04-02_231122/skills/test-location-rules/routing-edge-cases.md`
- `doc/tests/2026-04-02_231122/skills/test-location-rules/dynamic-execution-cases.md`
- `doc/tests/2026-04-02_231122/skills/test-location-rules/github-vt2geojson-real-drill.md`
