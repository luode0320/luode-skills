...
version: v1.0
template_version: 1
current_slice: 审查与验收域最小任务 03 test 已完成
...
结果：route 返回 `candidate_count=5`、`valid=true`、`errors=[]`；validator 校验 description 哈希、正负 fixture、保护语义、冻结 assets、共享 reference 与 retained-specialized 边界。
