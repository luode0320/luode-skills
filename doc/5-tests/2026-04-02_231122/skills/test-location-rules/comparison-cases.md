...
- 旧 skill 预期结论：
  ...
  - 源码目录 `*_test.go` 禁放
  - 中文不能进入 Go 可编译路径
  - 白盒同包不是特例，应该先改 seam，再把测试资产放回 `doc/5-tests/<时间戳>/` 的 ASCII 镜像路径
- 新 skill 集合预期结论：
...
- 本文件是 `doc/5-tests/2026-04-02_231122/test-location-rules拆分对照验证/README.md` 的详细证据文档。
