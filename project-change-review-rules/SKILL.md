...
- 默认先读取 `references/shared-evidence-and-specialized-contracts.md`，再按其中路由读取 `references/checklist.md`、`references/report-template.md` 与 artifact-delivery-gate 共享契约。
