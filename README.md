...
让 AI 在参与团队研发时，能够从需求、Bug、编码、真实测试、`6-review` 风格回归到交付的全流程中，按照任务阶段和代码改动位置自动触发对应规则，而不是依赖人工每次手动拼接 Skill。
...
- 用户如果显式在问“这件事怎么做 / 先给计划 / 先出方案 / 先列步骤 / 这个怎么改”，必须先命中 `implementation-planning-rules`；若前置条件未齐，也要输出受限计划 / 阻断计划，而不是表现成计划规则没有触发；当前上下文处于 `Plan Mode` 时，同样必须先命中 `implementation-planning-rules` 作为第一层计划外壳，再按需回流需求侦察、需求接入、缺口、边界、拆分或其他域
...
- `implementation-planning-rules` 负责正式编码前的只读计划模式：计划阶段禁止写代码、禁止边计划边试做，只允许读仓库、定依赖、列风险、拆任务和写实施文档；新项目、项目初期或多来源对象存在多份需求 / 实施文档时，先在 `doc/3-实施/` 维护“需求与实施计划全量顺序实施方案”，把需求、验收标准、实施总览、实施周期和周期内最小任务按总顺序串起来；计划正文开头必须先写“当前计划最终方案的简要说明”，用 1-3 句先交代推荐方案、主落点和为什么这么做；随后再写 agent 对当前问题的理解，至少交代问题 / 目标、本轮范围、非范围、当前优先闭环和关键假设 / 待确认点，再把实施周期写成第一期、第二期、第三期等大进度单位，明确周期顺序、期次定位、进入条件、收口条件和周期内最小任务顺序；周期内部按“依赖图 + 垂直切片”拆最小闭环，不按前端 / 后端 / 数据库水平分层堆任务，单任务默认尽量控制在约 5 个文件以内；凡是代码生成、修改或重构类计划，都要把真实测试入口、依赖环境、样本 / 数据来源和通过标准写出来，`build`、`lint` 和静态检查不算真实测试；若计划涉及代码生成、修改或重构，“现状与落点”必须给出代码落点目录树，不能只写文件名或普通条目；当前上下文处于 `Plan Mode` 时，必须把 `implementation-planning-rules` 作为第一层计划外壳先命中，再按需回流需求侦察、需求接入、缺口、边界、拆分或其他域
...
- 一旦用户明确开始实施，且计划与停止边界齐备，就默认先定位当前实施周期（第一期、第二期、第三期等大进度），再在当前周期内按最小任务自动串行推进“最小任务实现 -> 最小任务真实测试 -> 6-review 风格回归 -> 下一最小任务”；每个最小任务都必须先完成自己的真实测试和 6-review 闭环，当前周期全部最小任务收口后再进入下一周期，不再等待用户逐步下达“进入测试/进入 6-review/继续下一个任务或周期”，也不得先连续实现多个任务后统一测试
...
| `knowledge-flow` | 仓库任务每轮先做 `知识库:<检索/沉淀/不适用/阻断>` 选择性默认判断；只有历史知识依赖或收口沉淀价值成立时，才用标准文件工具检索、捕获或沉淀知识库笔记。 |
...
2026-07-03 00:45:19 docs: [需求文档单一化] 收口需求正文图示规则
2026-07-03 01:52:14 docs: [Plan Mode 计划路由] 升级计划 skill 路由
2026-07-03 02:42:10 docs: [Plan Mode 自举收口] 同步计划外壳到项目自举与字典
...
2026-07-04 17:02:53 feat: [subagent并发上限治理] 新增并发上限5与空闲回收强制条款并补齐脚本批次拆分
...
2026-07-05 19:21:55 docs: [实施计划模板优化] 计划从1开始并单列真实测试安排
2026-07-05 21:34:00 docs: [会话标题过程触发] 支持提问与goal阶段中途改名
2026-07-05 22:34:39 docs: [实施总顺序文档] 新增需求与实施计划全量顺序实施方案规则
2026-07-06 11:46:42 fix: [WSL用户文件引用] 解除路径规则与agent运行位置绑定
...
2026-07-07 01:33:32 feat: [知识流全量沉淀] 增加 Obsidian vault 逐篇沉淀脚本
2026-07-07 21:18:25 docs: [输出限制] 补充 optional commentary 约束
2026-07-07 09:55:23 docs: [Go反模式补充] 新增避免转发式冗余封装规则
...
2026-07-09 22:14:21 docs: [Karpathy硬闸门审查] 归档项目自举规则改动审查
2026-07-09 22:15:55 feat: [Karpathy硬闸门] 同步项目自举规则
2026-07-09 16:02:36 docs: [函数拆分规则审查] 归档当前改动审查
2026-07-09 16:07:17 docs: [函数拆分颗粒规则] 允许简单检查就地表达
2026-07-09 22:51:32 chore: [同步远端] 合并最新代码
2026-07-10 16:14:11 chore: [系统Skill同步] 更新内置Skill说明
2026-07-10 16:15:38 feat: [Git提交基础核查] 改为staged直接核查
2026-07-10 16:17:02 docs: [当前改动审查] 改为staged直接审查
2026-07-10 16:18:03 docs: [Git基础核查审查] 归档当前改动审查
2026-07-10 21:54:08 docs: [PowerShell保底规则审查] 归档当前改动审查
2026-07-10 21:59:17 feat: [PowerShell专项保底] 补充Windows执行兜底规则
2026-07-11 22:45:00 feat: [项目四件套记忆] 同步本地记忆闭环与Obsidian分层规则
2026-07-11 22:55:00 docs: [项目四件套需求] 落盘需求说明
2026-07-11 22:56:00 docs: [项目四件套实施] 落盘实施总览
2026-07-11 22:57:00 test: [项目四件套验证] 归档测试结果
...
2026-07-12 03:30:44 feat: [执行失败学习] 建立持续学习与主动预防闭环
2026-07-12 03:32:10 docs: [执行失败学习需求] 归档需求文档
2026-07-12 03:39:00 feat: [文档落盘闸门] 补齐工程文档验证资产
2026-07-12 03:40:00 docs: [需求文档完整性] 归档需求与实施文档完整性
2026-07-12 03:41:00 feat: [文档落盘闸门] 补齐工程文档验证资产
2026-07-12 03:42:00 docs: [需求文档完整性] 回写交接引用与验收入口
2026-07-12 03:43:00 feat: [需求完整性规则] 补齐极致完备性交接门禁
2026-07-12 03:44:00 docs: [执行失败学习实施] 归档实施总览与周期闭环
2026-07-12 03:45:00 test: [执行失败学习验证] 归档前向行为测试资产
2026-07-12 03:46:00 feat: [实施计划模板] 补齐实施总览交接模板
2026-07-12 03:47:00 docs: [执行失败学习审查] 归档当前改动总审查
2026-07-12 03:48:00 feat: [实施计划规则] 补齐周期与最小任务模板
2026-07-12 03:49:00 docs: [执行失败学习验收] 归档验收标准与最终结论
2026-07-12 03:50:00 fix: [文档校验脚本] 强化元数据与图表内容校验
2026-07-12 03:51:00 docs: [需求文档元数据] 补齐当前切片字段
2026-07-12 03:52:00 docs: [验收文档元数据] 补齐当前验收切片字段
2026-07-12 03:53:00 fix: [文档校验脚本] 修正章节内容与占位词判定
2026-07-12 03:54:00 docs: [验收标准补充] 明确通过与失败阻断标准
2026-07-12 03:55:00 docs: [文档完整性实施] 补齐契约与可执行字段
2026-07-12 03:56:00 feat: [文档质量配置] 增加实施总顺序校验 profile
...
2026-07-12 15:31:00 docs: [需求文档完整性] 完善极致完备化契约
2026-07-12 15:32:00 docs: [实施文档完整性] 补齐周期与执行证据
2026-07-12 15:33:00 test: [文档规则验证] 归档自动化测试证据
2026-07-12 15:34:00 test: [文档校验器测试] 增补验证用例
2026-07-12 15:35:00 docs: [实施审查证据] 归档分周期审查结论
2026-07-12 15:36:00 docs: [实施验收结论] 归档周期验收与最终放行
2026-07-12 17:41:00 chore: [图像通道与引导规则] 同步当前配置与脚本
2026-07-12 17:42:00 docs: [图像通道实施方案] 归档周期契约与验证
2026-07-12 17:43:00 test: [图像通道回归验证] 归档本地测试证据
2026-07-12 17:44:00 docs: [图像通道实施审查] 归档当前改动审查
2026-07-12 17:45:00 chore: [项目当前状态] 同步提交后交接状态
2026-07-12 21:50:21 feat: [上线测试与运行期恢复] 落地引擎与统一自恢复规则
2026-07-12 21:55:07 docs: [上线测试需求文档] 归档运行期自恢复与测试引擎需求
2026-07-12 21:55:42 docs: [上线测试实施文档] 归档全量实施方案与周期任务
2026-07-12 21:56:19 test: [上线测试验证资产] 归档本地回归与引擎测试证据
2026-07-12 21:56:55 docs: [上线测试改动审查] 归档当前变更审查结论
2026-07-12 21:57:37 docs: [上线测试最终验收] 归档验收标准与结论
2026-07-12 21:58:22 chore: [项目当前状态] 同步本轮提交后工作树状态
2026-07-13 18:57:17 docs: [Obsidian桥接与风格反馈需求] 归档跨宿主CLI桥接与风格反馈迭代需求文档
2026-07-13 18:59:56 docs: [Obsidian桥接与风格反馈实施方案] 归档两项需求的实施总览与执行周期
2026-07-13 19:00:18 test: [Obsidian桥接与风格反馈与微业务隔离验证] 归档本地回归测试证据
2026-07-13 19:02:13 docs: [Obsidian桥接与项目底座审查] 归档分周期与端到端改动审查结论
2026-07-13 19:03:31 docs: [Obsidian桥接与风格反馈验收] 归档验收标准与最终验收结论
2026-07-13 19:04:58 feat: [跨宿主Obsidian桥接与全局风格反馈库] 落地bridge调用链、风格反例学习流程与微业务架构skill
2026-07-13 21:01:11 feat: [文档白话化] 统一共享契约与条件化门禁规则
2026-07-13 21:05:35 test: [文档白话化] 补齐校验器回归用例
2026-07-13 21:08:19 docs: [需求文档] 接入白话门禁元数据
2026-07-13 21:09:27 docs: [实施文档] 接入白话门禁元数据
2026-07-13 21:10:27 docs: [验收文档] 接入条件化门禁证据
2026-07-13 21:11:20 docs: [审查文档] 明确提交边界与放行结论
2026-07-13 21:12:27 chore: [项目当前状态] 同步本次提交后工作树状态
2026-07-13 23:15:54 feat: [PowerShell环境可靠性升级] 落地状态契约与安全回滚
2026-07-13 23:16:40 docs: [PowerShell可靠性需求] 归档环境升级需求与边界
2026-07-13 23:17:16 docs: [PowerShell可靠性实施] 归档实施总览与交付周期
2026-07-13 23:17:51 test: [PowerShell可靠性验证] 归档隔离回归测试证据
2026-07-13 23:18:27 docs: [PowerShell可靠性审查] 归档当前改动审查结论
2026-07-13 23:19:13 docs: [PowerShell可靠性验收] 归档验收标准与最终结论
2026-07-13 23:20:30 chore: [项目当前状态] 同步PowerShell提交后工作树状态
2026-07-14 00:02:38 chore: [Git提交边界] 区分基础核查与正式审查验收
2026-07-14 00:05:58 chore: [项目当前状态] 同步Git提交后工作树状态
2026-07-14 01:54:56 docs: [任务阻断收口需求] 归档阻断契约与恢复边界
2026-07-14 01:55:50 docs: [任务阻断收口实施] 归档阻断收口实施方案
2026-07-14 01:56:23 docs: [任务阻断收口审查] 归档阻断收口改动审查
2026-07-14 01:57:00 docs: [任务阻断收口验收] 归档最终验收与恢复边界
2026-07-14 01:58:16 test: [任务阻断收口验证] 补齐阻断事实与文档门禁测试
2026-07-14 01:59:29 test: [Obsidian案例契约验证] 归档执行失败持续学习测试证据
2026-07-14 02:01:07 feat: [任务阻断收口] 落地共享阻断契约与案例恢复规则
2026-07-14 02:03:23 test: [Obsidian案例契约修订] 对齐案例状态与验证断言
2026-07-14 02:06:19 test: [Obsidian案例渲染验证] 覆盖正反例与环境边界
2026-07-14 02:06:56 fix: [Obsidian案例渲染] 修复正反例字段渲染并收紧路径契约
2026-07-14 02:09:02 chore: [项目当前状态] 同步任务阻断收口提交状态
2026-07-14 02:22:58 fix: [Obsidian案例安全边界] 收紧案例渲染与桥接路径
2026-07-14 02:26:29 test: [Obsidian案例安全验证] 补齐精确匹配与脱敏回读
2026-07-14 02:27:49 chore: [Obsidian知识流状态] 同步当前任务与长期记忆
2026-07-14 02:34:31 fix: [Obsidian案例注释] 补齐渲染器函数注释契约
2026-07-14 02:35:59 test: [Obsidian案例注释] 补齐测试辅助函数注释契约
2026-07-14 14:01:19 feat: [Swag上游文档] 增加上游出站接口规则
2026-07-14 14:04:26 test: [Swag上游文档测试] 归档离线校验证据
2026-07-14 14:06:48 docs: [Swag上游文档审查] 归档实现与当前改动审查
2026-07-14 14:10:11 chore: [项目当前状态] 同步Swag提交后工作树状态
2026-07-15 15:31:46 feat: [代码生成风格] 增加局部一致性与接口实现对照规则
2026-07-15 15:33:41 docs: [代码风格需求] 更新局部一致性与接口实现需求
2026-07-15 15:35:06 docs: [代码风格实施] 更新实施周期与收口追踪
2026-07-15 15:35:42 test: [代码风格测试] 归档局部一致性与接口实现证据
2026-07-15 15:37:51 docs: [代码风格审查] 归档实现自审与当前改动审查
2026-07-15 15:40:28 docs: [代码风格验收] 归档最终验收与放行结论
2026-07-16 10:37:47 docs: [规则更新审查] 归档实现自审与当前改动总审查
2026-07-16 10:37:47 feat: [注释步骤规则] 增加长代码块内步骤注释
2026-07-16 10:37:47 chore: [项目记忆同步] 更新当前状态与长期规则
2026-07-21 11:36:32 docs: [Skill体积治理与拆分] 归档需求文档
2026-07-21 11:37:19 docs: [Skill体积治理与拆分] 归档实施周期文档
2026-07-21 11:38:08 test: [Skill体积治理与拆分] 归档拆分验证测试任务
2026-07-21 11:38:45 docs: [Skill体积治理与拆分] 归档改动总审查
2026-07-21 11:39:04 docs: [Skill体积治理与拆分] 归档验收标准
...
2026-07-24 00:47:52 refactor: [需求域 Skill] 收口旧路由与职责边界
2026-07-24 00:51:16 feat: [任务协作工具] 增加线程改名与计划恢复能力
2026-07-24 00:56:00 test: [线程改名工具] 通过 MCP 测试
2026-07-24 00:57:00 test: [计划恢复工具] 通过投影测试
2026-07-24 01:15:14 chore: [上游规则同步] 整合最新规则与安全契约
...
2026-07-25 13:23:00 docs: [Bug域与Goal投影需求] 归档需求与验收边界
2026-07-25 13:24:00 docs: [Bug域与Goal投影实施] 归档实施周期与全量方案
2026-07-25 13:25:00 test: [Bug域与Goal投影测试] 归档自动化验证证据
2026-07-25 13:26:00 docs: [Bug域改动审查] 归档当前改动审查
2026-07-25 13:27:00 docs: [Bug域与Goal投影验收] 归档最终验收记录
2026-07-25 13:28:00 chore: [项目当前状态] 同步提交完成后的工作树状态
2026-07-26 00:00:00 feat: [研发规则与测试引擎] 完善任务治理与外部场景执行
2026-07-26 00:05:00 docs: [研发规则需求] 同步外部场景、质量监督与任务治理需求
2026-07-26 00:06:00 docs: [研发规则实施] 归档测试引擎与任务治理实施方案
2026-07-26 00:07:00 test: [研发规则测试] 归档外部场景与任务治理验证证据
...
2026-07-27 10:42:16 docs: [Skill触发词补充] 同步聚合指令识别与字典刷新
2026-07-27 11:19:21 docs: [总结闸门预声明] 命中检查提前登记收口Owner并刷新字典
2026-07-27 11:45:13 docs: [延迟触发gate注册表] 新增闸门预告统一登记机制并同步字典
2026-07-28 01:44:12 feat: [代码位置目录规则V2] 统一公共工具、配置、数据库与前端目录落点
2026-07-29 00:00:00 test: [代码位置目录规则V2] 覆盖目录落点、微业务隔离与目录生成器回归
2026-07-29 00:01:00 docs: [代码位置目录规则V2需求] 归档目录落点规则需求与边界
2026-07-29 00:02:00 docs: [代码位置目录规则V2实施] 归档目录落点实施总览
2026-07-29 00:03:00 docs: [代码位置目录规则V2审查] 归档实现与当前改动审查
2026-07-29 00:04:00 docs: [代码位置目录规则V2验收] 归档最终验收标准与结论
2026-07-29 00:05:00 chore: [项目状态同步] 更新规则记忆、样式与当前交接状态
2026-07-29 15:19:26 feat: [最小计划分级] 新增非PlanMode中等改动最小计划路由
...
2026-07-30 00:00:00 feat: [代码位置目录规则V2修订] 补齐治理文件、IP工具与脚手架约束
2026-07-30 00:01:00 test: [代码位置目录规则V2修订] 补充治理文件与目录查询回归证据
2026-07-30 00:02:00 docs: [代码位置目录规则V2修订需求] 同步治理文件与IP工具规则边界
2026-07-30 00:03:00 docs: [代码位置目录规则V2修订实施] 更新实施总览与任务闭环
2026-07-30 00:04:00 docs: [代码位置目录规则V2修订审查] 更新实现与当前改动审查
2026-07-30 00:05:00 docs: [代码位置目录规则V2修订验收] 更新最终验收标准与结论
2026-07-30 00:06:00 chore: [项目状态同步] 更新目录规则修订后的交接与项目记忆
2026-07-31 00:00:00 feat: [代码位置目录规则V2数据存储] 补齐数据库目录与字段SQL落点
2026-07-31 00:01:00 test: [代码位置目录规则V2数据存储] 补充数据库目录与脚手架回归测试
2026-07-31 00:02:00 docs: [代码位置目录规则V2数据存储需求] 同步数据库目录与字段SQL边界
2026-07-31 00:03:00 docs: [代码位置目录规则V2数据存储实施] 补齐数据存储目录实施周期
2026-07-31 00:04:00 docs: [代码位置目录规则V2数据存储审查] 更新实现与当前改动审查
2026-07-31 00:05:00 docs: [代码位置目录规则V2数据存储验收] 更新最终验收标准与结论
2026-07-31 00:06:00 chore: [项目状态同步] 更新数据存储目录修订后的项目交接
2026-07-31 15:20:00 feat: [代码位置目录规则V2删除根data] 删除后端根data目录规则
2026-07-31 15:21:00 test: [代码位置目录规则V2删除根data] 补充根data删除回归测试
2026-07-31 15:22:00 docs: [代码位置目录规则V2删除根data需求] 同步后端根data删除需求
2026-07-31 15:23:00 docs: [代码位置目录规则V2删除根data实施] 补齐删除根data实施周期
2026-07-31 15:24:00 docs: [代码位置目录规则V2删除根data审查] 更新实现与当前改动审查
2026-07-31 15:25:00 docs: [代码位置目录规则V2删除根data验收] 更新最终验收标准与结论
2026-07-31 15:26:00 chore: [项目状态同步] 更新删除根data后的项目交接
2026-08-01 00:00:00 feat: [Skill流程收敛] 完成技能规则与门禁调整
...
2026-08-01 01:01:00 test: [6-review流程收敛] 补充静态来源与Owner回归测试
...
2026-08-01 02:02:00 docs: [测试资产统一] 更新根test目录统一需求实施与6-review文档
2026-08-01 02:03:00 chore: [项目状态同步] 更新根test目录统一后的项目交接
2026-08-02 13:56:10 feat: [任务投影清理] 增加七天完成投影清理
2026-08-02 13:56:40 test: [任务投影清理] 补充七天清理回归测试
2026-08-02 13:57:20 feat: [会话交接Skill] 新增脱敏交接规则与校验脚本
2026-08-02 13:57:55 test: [会话交接Skill] 补充交接包契约测试
2026-08-02 13:58:30 docs: [PROJECT_CURRENT任务记录需求] 归档七天保留需求
2026-08-02 13:59:05 docs: [PROJECT_CURRENT任务记录实施] 归档七天保留实施计划
2026-08-02 13:59:40 docs: [会话交接Skill审查] 归档风格回归记录
2026-08-02 14:00:20 chore: [项目状态同步] 更新交接与投影清理状态
2026-08-02 18:00:10 feat: [Git提交域收敛] 更新docs、test与实现分域规则
2026-08-02 18:00:40 test: [Git提交域收敛] 补充提交域门禁回归测试
2026-08-02 18:01:10 docs: [Git提交域收敛] 同步项目状态字典与6-review
2026-08-02 23:45:57 docs: [目录规则收口] 同步规则文档、实施证据与项目状态
2026-08-02 23:50:00 test: [目录规则收口] 补充配置入口与测试资产回归
2026-08-02 23:55:00 feat: [目录规则收口] 完善配置与二进制入口校验
...
2026-08-04 20:33:53 docs: [总结知识引用清单_Obsidian引用可视化] 归档CYCLE-21实施周期
2026-08-04 20:34:22 feat: [知识引用清单] 新增Obsidian引用台账与总结知识引用小节
2026-08-04 20:34:55 docs: [字典同步] 刷新知识引用清单相关Skill描述
2026-08-04 20:35:31 docs: [总结知识引用清单_Obsidian引用可视化] 归档CYCLE-21测试证据
2026-08-04 20:35:58 test: [知识引用清单] 新增Obsidian引用契约回归测试
2026-08-04 20:36:34 docs: [总结知识引用清单_Obsidian引用可视化] 归档CYCLE-21审查与状态收口
...
2026-08-06 00:11:00 test: [配置来源安全边界] 补充配置来源与秘密边界回归
2026-08-06 00:12:00 docs: [配置来源安全边界] 归档测试证据与风格回归
2026-08-07 09:56:44 docs: [知识库可迭代更新] 归档需求文档
2026-08-07 09:57:23 docs: [知识库可迭代更新] 归档实施总览与实施周期21-23
2026-08-07 09:57:52 feat: [知识库可迭代更新] 新增冲突取代与废弃治理机制
2026-08-07 09:58:44 docs: [字典同步] 刷新知识库可迭代更新相关Skill描述
2026-08-07 09:59:13 docs: [知识库可迭代更新] 归档测试证据
2026-08-07 09:59:42 test: [知识库可迭代更新] 新增bridge请求与知识库审计契约测试
2026-08-07 10:00:11 docs: [知识库可迭代更新] 归档审查与项目状态收口
2026-08-07 10:11:39 merge: [分支合并] 合并origin/main，解决PROJECT_CURRENT/HISTORY/README/字典/AGENTS-CLAUDE五处冲突

2026-08-10 15:01:00 docs: [凭据默认代码持久化与最近会话快照] 归档需求、实施、测试证据与6-review
2026-08-10 15:00:30 test: [凭据策略与最近会话快照] 补充凭据策略契约测试与快照同步测试
2026-08-10 15:00:00 feat: [凭据默认代码持久化与最近会话快照] 统一凭据来源优先级口径，新增最近会话快照脚本与契约

2026-08-07 16:29:54 fix: [Mermaid生成规则空白点] 新增标签比较运算符转义规则
2026-08-07 16:30:33 test: [Mermaid生成规则空白点] 新增标签转义正负例回归
2026-08-07 16:31:04 docs: [项目状态同步] 归档Mermaid规则修复的当前状态与历史事件
2026-08-11 00:00:00 feat: [PlanMode选择框空白无效选项] 新增选项载荷前校验与闸门规则
2026-08-11 00:00:30 test: [PlanMode选择框空白无效选项] 新增选项载荷前校验回归测试
2026-08-11 00:01:00 docs: [PlanMode选择框空白无效选项] 归档实施周期、测试证据与6-review
2026-08-11 00:30:00 feat: [Mock治理删除] 移除运行时Mock全套规则、目录、脚本与检查
2026-08-11 00:30:30 test: [Mock治理删除] 移除运行时Mock回归测试并同步共享布局策略
...
2026-08-11 14:59:08 docs: [字典同步] 刷新Bug与测试文档扁平化相关Skill描述
2026-08-11 14:59:45 docs: [项目治理同步] 更新规则记忆与验收索引
2026-08-11 15:00:52 feat: [跨项目写入红线] AGENTS/CLAUDE新增仓库级重申规则
2026-08-12 18:15:13 docs: [知识库迁移] 归档实施总览
...
2026-08-18 16:42:13 feat: [代码位置目录规则] 重构版本化目录并移除rpc条目与函数
2026-08-18 16:43:32 chore: [忽略配置] 新增.disable*忽略项
...
2026-08-18 23:59:30 feat: [新增skill] cgo插件包隔离测试
2026-08-18 23:59:50 feat: [外部skill] 新增write自然改写skill
2026-08-19 00:00:00 docs: [接口测试重构收尾] 归档项目状态字典与编码skill文档
2026-08-19 00:01:00 feat: [write精华吸收] 自然行文规则与标点检查脚本本地化
2026-08-19 00:01:30 feat: [write精华吸收] 交付闸门引用自然行文与标点门禁
...
2026-08-19 19:07:00 chore: [放行非代理改动] thread-title脚本移除与skillhub元数据同步
2026-08-19 23:52:00 docs: [测试域skill收敛去重] 样本矩阵与双根落点改单一权威引用、apifox用例模块边界与门控归一、清理散落模板
2026-08-20 00:18:00 docs: [吸收规则双通道扩展] skill-absorption-rules 增加内部更新通道与双通道判定、同域去重两通道同等强制
2026-08-20 00:37:00 docs: [三域skill整理] 需求/实施/Bug 三域收敛去重——delivery-gate 测试域细则改引用、Bug 模板重命名规范化、裁决表登记（实测三域已健康，净减 200B）
2026-08-19 17:08:08 chore: [清理废弃文件] 删除临时脚本与过期模板
2026-08-19 17:08:41 feat: [apifox接口测试落地] 模块扩展与元数据同步
2026-08-19 17:09:17 feat: [skill工程化批量更新] 数据库/测试/缓存/吸收规则增强
2026-08-19 17:14:05 feat: [skill工程化批量更新] 项目记忆/规则自举/交付/其它skill同步
...
2026-08-23 18:15:00 docs: [项目状态同步] 任务投影跨宿主适配实施/缺陷/测试/6-review 文档落盘
2026-08-23 21:25:00 feat: [平台中断防护] summary-check双检测与压缩阈值回归
...
2026-08-25 00:50:00 docs: [字典同步] 刷新skill字典数据与统计
2026-08-25 22:22:00 feat: [记忆计数锚点链路] 健康检查与存量项目回补
2026-08-25 22:23:00 feat: [日志链路打通] log-analysis-rules读侧唯一权威与四处联动
2026-08-25 22:24:00 feat: [apifox权限豁免] 测试专用项目豁免与开放API代填
2026-08-25 22:25:00 docs: [项目状态同步] 日志链路打通需求/实施/6-review 文档落盘
2026-08-25 22:26:00 chore: [skillhub元数据同步] 图标重试时间戳
...
2026-09-01 22:42:00 docs: [字典同步] 重建skill字典数据与统计
2026-09-01 22:43:00 docs: [apifox用例] 补规则T4伪失败四坑与写库幂等
